...
<div class="container">
    <div class="row d-flex justify-content-center flex-nowrap">
        ...
        <div class="col ">
            <img src="image/institutcoif2.jpg"> 
        </div>

        <div class="col ">
        </br></br></br></br>
        <h2 class='col-lg-6 offset-lg-3'>Institut</h2></br>

            <form method="POST" action="institut_traitement.php" class='col-lg-6 offset-lg-3'>
        ...
        <div class="col ">
            <img src="image/institutcoif.jpg"> 
        </div>
    </div>
</div>
<?php
